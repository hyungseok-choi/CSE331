 ...
 */
public class Path<T> implements Iterable<Path<T>.Segment<T>> {
    ...
    public Iterator<Segment<T>> iterator() {
        ...
        return new Iterator<Segment<T>>() {

            private Iterator<Segment<T>> backingIterator = path.iterator();
